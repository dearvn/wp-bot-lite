                ...
                (settings.enable_ai !== 'yes' || settings.api_key.length === 0) ?
                    <div className="mt-5 bg-white shadow-md p-5 max-w-[600px]">
                        <h3 className="font-medium text-lg">
                            {__('Binance API key is not configured properly.', 'botlite')}
                        </h3>
                        <p>
                            {__('To get your automatic AI content generation tool, you must have to activate your Binance API key and enable the settings.', 'botlite')}
                        </p>
                        <p>
                            <Button
                                type='default'
                                buttonCustomClass={'bg-gradient-to-r from-gradient-from to-gradient-to !border-0 mt-4'}
                                textClassName={'text-white'} text={__('Go to settings', 'botlite')}
                    ...
                    <div className='flex flex-col md:flex-row flex-1'>
                        <div
                            ...
                            <h3 className="font-medium text-lg text-success">
                                {__('AI configuration is successful.', 'botlite')}
                            </h3>
                            <p className='pb-6'>
                                {__('You can now use your Automatic AI content generation tool.', 'botlite')}
                            </p>
                        </div>
                        <div className="md:basis-[50%] mt-5 bg-white shadow-md p-5 md:ml-4">
                            <h3 className="font-medium text-lg text-success">
                                {__('New content', 'botlite')}
                            </h3>
                            <div className='mt-2'>
                                {__('Create New post and use our automated AI generated content features.', 'botlite')}
                            </div>
                            <div className='mt-4'>
                                <a
                                    href={botlite.urls.newPost}
