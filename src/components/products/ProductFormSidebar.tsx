...
export default function ProductFormSidebar({ loading }: Props) {
    ...
    const menus = [
        {
            slug: 'product-general-info',
            label: __('General Information', 'landlite'),
        },
        {
            slug: 'product-description-info',
            label: __('Product Description', 'landlite'),
        },
        {
            slug: 'product-city-info',
            label: __('City Information', 'landlite'),
        },
    ];
